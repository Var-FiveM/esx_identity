...
if Config.UseDeferrals then
                        ...
                        deferrals.presentCard(
                            ...
                            function(data)
                                if data.firstname == "" or data.lastname == "" or data.dateofbirth == "" or data.sex == "" or data.height == "" then
                                    ...
                                    if checkNameFormat(data.firstname) and checkNameFormat(data.lastname) and data.dateofbirth and checkSexFormat(data.sex) and checkHeightFormat(data.height) then
                                        playerIdentity[identifier] = {
    ...
    ESX.RegisterServerCallback("esx_identity:registerIdentity", function(source, cb, data)
        ...
        local formattedDate = data.dateofbirth
